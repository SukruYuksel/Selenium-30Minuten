...
public class ActionsClassUygulama {
    ...
    public void test01() {
        ...
        WebElement titlRadioButton=driver.findElement(By.xpath("(//input[@id='id_gender1'])"));
        actions.click(titlRadioButton)
                .sendKeys(Keys.TAB)
                .sendKeys("Ahmet")
                .sendKeys(Keys.TAB)
                .sendKeys("12345")
        ...
        WebElement firstNameIkon= driver.findElement(By.xpath("(//input[@type='text'])[3]"));
        firstNameIkon.sendKeys("Ahmet");
        actions.click(firstNameIkon)
                .sendKeys(Keys.TAB)
                .sendKeys("bulut")
                .sendKeys(Keys.TAB)
                .sendKeys("kendim")
